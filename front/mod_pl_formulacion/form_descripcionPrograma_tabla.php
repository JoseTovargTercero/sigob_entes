    ...
    <div class="pc-container">
        <div class="pc-content">
                ...
                <h5 class="mb-0"></h5>
                            ...
                            <div class=" d-flex justify-content-between">
                                <h4 class="fw-bold py-3 mb-4">
                                    ...
                                    <span class="text-muted fw-light">Configuracion /</span> Descripcion de programas
                                </h4>
            ...
            <div class="row mb3">
                ...
                <div class="col-lg-12 mb-3" id="descripcion-programa-view">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <button class="btn btn-primary" id="descripcion-programa-registrar">REGISTRAR</button>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive p-1">
                                <table id="descripcion-programa-table" class="table table-striped" style="width:100%">
                                    <thead class="w-100">
