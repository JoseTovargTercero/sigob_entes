    ...
    <div class="pc-container">
        <div class="pc-content">
                ...
                <h5 class="mb-0"></h5>
                            ...
                            <div class=" d-flex justify-content-between">
                                <h4 class="fw-bold py-3 mb-4">
                                    ...
                                    <span class="text-muted fw-light">Teoría y leyes /</span> Articulos
                                </h4>
            ...
            <div class="row mb3">
                ...
                <div class="col-lg-12 mb-3" id="titulo-1-view">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive p-1">
                                <table id="titulo-1-table" class="table table-striped" style="width:100%">
                                    <thead class="w-100">
