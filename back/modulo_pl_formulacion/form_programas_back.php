...
function actualizar($info)
{
    ...
    $condicion_consulta = "sector = '$sector' AND programa = '$programa' AND id != $id"; // Condición para buscar registros
...
function eliminar($id)
{
    ...
    $condicion_consulta = "programa = $id"; // Condición para buscar registros
